...
class Graphic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('project_id, user_id, sketch, valid, finish, time, time_est', 'numerical', 'integerOnly'=>true),
			array('name, description, file, deadline', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, project_id, user_id, name, description, file, sketch, valid, finish, deadline, time, time_est', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Graphic', array(
			'criteria'=>$criteria,
		));
	}
