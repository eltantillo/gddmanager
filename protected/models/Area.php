...
class Area extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, description, characteristics, connections', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, project_id, name, description, characteristics, connections', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'levels' => array(self::HAS_MANY, 'Level', 'Area_id'),
		);
	}
