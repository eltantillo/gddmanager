...
class Screen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('project_id, user_id, finish, code, valid, test, time, time_est', 'numerical', 'integerOnly'=>true),
			array('graphics, sounds, music, name, description, file, deadline', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, project_id, user_id, graphics, sounds, music, name, description, file, finish, code, valid, test, deadline, time, time_est', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'components' => array(self::HAS_MANY, 'Component', 'Screen_id'),
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Screen', array(
			'criteria'=>$criteria,
		));
	}
