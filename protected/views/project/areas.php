...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo Language::$areas; ?></li>
  </ol>
</section>
...
<section class="content-header">
  <form method="POST">
  	...
  	<button class="btn btn-success"><i class="fa fa-map-o"></i> <?php echo Language::$createNew . ' ' . Language::$area; ?></button>
  </form>
</section>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <div class='info-box-text'><h3><p><?php echo $area->name ?></p></h3></div>
      <?php echo Functions::subString(strip_tags($area->description), 64); ?>
    </div>
    
    <a href="<?php echo URL . '/area/update/' . $area->id . '?project=' . $model->id;?>" class="small-box-footer">
