...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo Language::$music; ?></li>
  </ol>
</section>
...
<section class="content-header">
  <form method="POST">
  	...
  	<button class="btn btn-success"><i class="fa fa-music"></i> <?php echo Language::$createNew . ' ' . Language::$music; ?></button>
  </form>
</section>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <div class='info-box-text'><h3><p><?php echo $mus->name ?></p></h3></div>
      <?php echo Functions::subString(strip_tags($mus->description), 64); ?>
    </div>
    
    <a href="<?php echo URL . '/music/update/' . $mus->id . '?project=' . $model->id;?>" class="small-box-footer">
