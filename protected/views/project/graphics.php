...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo URL . '/project/art/' . $model->id;?>"><?php echo Language::$gameArt; ?></a></li>
    <li class="active"><?php echo Language::$graphics; ?></li>
  </ol>
</section>
...
<section class="content-header">
  <form method="POST">
  	...
  	<button class="btn btn-success"><i class="fa fa-image"></i> <?php echo Language::$createNew . ' ' . Language::$graphic; ?></button>
  </form>
</section>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <div class='info-box-text'><h3><p><?php echo $graphic->name ?></p></h3></div>
      <?php echo Functions::subString(strip_tags($graphic->description), 64); ?>
    </div>
    
    <a href="<?php echo URL . '/graphic/update/' . $graphic->id . '?project=' . $model->id;?>" class="small-box-footer">
