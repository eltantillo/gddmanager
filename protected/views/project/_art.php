...
<div class="box-header with-border">
	<h3 class="box-title"><?php echo Language::$gameArt; ?></h3>
</div>
...
<div class="box-body">
	...
	<div class="form-group">
		<label><?php echo Language::$artStyle; ?></label>
		<?php echo $form->textArea($model,'style', array('class'=>'form-control textarea', 'placeholder'=>Language::$artStyleDesc)); ?>
