...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo Language::$tasks; ?></li>
  </ol>
</section>
...
<section class="content-header">
  <form method="POST">
  	...
  	<button class="btn btn-success"><i class="fa fa-tasks"></i> <?php echo Language::$createNew . ' ' . Language::$taskString; ?></button>
  </form>
</section>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <div class='info-box-text'><h3><p><?php echo $task->name ?></p></h3></div>
      <?php echo Functions::subString(strip_tags($task->description), 64); ?>
    </div>
    
    <a href="<?php echo URL . '/task/update/' . $task->id . '?project=' . $model->id;?>" class="small-box-footer">
