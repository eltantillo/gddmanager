...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo Language::$levels; ?></li>
  </ol>
</section>
...
<section class="content-header">
  <form method="POST">
  	...
  	<button class="btn btn-success"><i class="fa fa-map-signs"></i> <?php echo Language::$createNew . ' ' . Language::$level; ?></button>
  </form>
</section>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
  ...
  <div class="small-box bg-green">
    ...
    <div class="inner">
      <div class='info-box-text'><h3><p><?php echo $level->name ?></p></h3></div>
      <?php echo Functions::subString(strip_tags($level->synopsis), 64); ?>
    </div>
    
    <a href="<?php echo URL . '/level/update/' . $level->id . '?project=' . $model->id;?>" class="small-box-footer">
