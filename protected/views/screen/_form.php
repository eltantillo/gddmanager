...
<div class="box-header with-border">
	<h3 class="box-title"><?php echo Language::$screen; ?></h3>
</div>
...
<div class="box-body">
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model,'name', array('class'=>'form-control', 'placeholder'=>'Name of the screen.', 'autofocus'=>true)); ?>
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'sounds'); ?>
	...
	<div class="form-group">
		...
		<?php echo $form->textArea($model,'description', array('class'=>'form-control textarea', 'placeholder'=>Language::$screenDesc)); ?>
