...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo URL . '/project/art/' . $project->id;?>"><?php echo Language::$gameArt; ?></a></li>
    <li><a href="<?php echo URL . '/project/graphics/' . $project->id;?>"><?php echo Language::$graphics; ?></a></li>
