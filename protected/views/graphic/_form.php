...
<div class="box-header with-border">
	<h3 class="box-title"><?php echo Language::$graphic; ?></h3>
</div>
...
<div class="box-body">
	...
	<div class="form-group">
		...
		<?php echo $form->textArea($model,'description', array('class'=>'form-control textarea', 'placeholder'=>Language::$graphicDesc)); ?>
