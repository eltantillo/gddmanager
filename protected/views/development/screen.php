...
<section class="content-header">
  <h1 class="hidden-xs"><?php echo Language::$development; ?> <small><?php echo Language::$screen; ?></small></h1>
...
<div class="jumbotron" data-step="1" data-intro="<?php echo Language::$developmentTaskHelp1; ?>" data-position="bottom">
    <div class="container">
        ...
        <?php if (in_array('admin', Yii::app()->user->roles) or in_array('artist', Yii::app()->user->roles) and !$model->finish){ $activities = true; ?>
...
<section class="content" data-step="3" data-intro="<?php echo Language::$developmentTaskHelp3; ?>" data-position="top">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  ...
                  <select id="state" name="state" class="form-control">
                    ...
                    <option value="valid" <?php if ($model->finish and !$model->valid){ echo "selected"; } ?>><?php echo Language::$viewValid; ?></option>
        ...
        <section class="col-lg-12 connectedSortable ui-sortable">
            <div class="box box-success box-solid">
                ...
                if($model->file != null){
                    ...
                    $file = Yii::app()->request->baseUrl . '/files/' . Yii::app()->user->company . '/' . $project->id . '/screens/' . $model->id . '.' . end($ext);
                    if (file_exists($_SERVER['DOCUMENT_ROOT'] . $file)){
                        echo '<div class="box-footer text-center">';
                        echo '<h4>' . Language::$design . '</h4>';
                        echo '<p>
        ...
        <section class="col-lg-12 connectedSortable ui-sortable">
            <div class="box box-success">
                ...
                <div class="box-body">
                  <?php
                    if ($model->time_est){
                        echo '<p>' . sprintf(Language::$screenTimeMessage, Functions::getTime($model->time_est * 60)) . '</p>';
                    }
                    if (count($timesheets) > 0){
                        echo '<p>' . sprintf(Language::$screenTimeCurrentMessage, Functions::getTime($model->time)) . '</p>';
                        //print part times
    ...
    <?php if (count($graphics) > 0 or count($sounds) > 0 or count($musics) > 0){ ?>
