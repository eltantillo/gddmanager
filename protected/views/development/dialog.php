...
<section class="content-header">
  <h1 class="hidden-xs"><?php echo Language::$development; ?> <small><?php echo Language::$dialog; ?></small></h1>
        ...
        <?php if (in_array('admin', Yii::app()->user->roles) or in_array('writer', Yii::app()->user->roles) and !$model->finish){ $activities = true; $submit = true; ?>
            <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <div class="form-group">
                    <h2><?php echo Language::$dialog; ?></h2>
                    <?php echo $form->textArea($model,'content', array('class'=>'form-control textarea', 'placeholder'=>Language::$scriptDesc)); ?>
                </div>
                <div class="form-group">
                    <label>
        ...
        <section class="col-lg-12 connectedSortable ui-sortable">
            <div class="box box-success box-solid">
                ...
                <div class="box-body">
                    <?php
  					if($model->context != null){
  					    echo '<h4>' . Language::$context . '</h4>';
  					    echo '<p>' . $model->context . '</p>';
  					}
                    ?>
                </div>
                <?php
                if($model->content != null){
                    echo '<div class="box-footer text-center">';
                    echo '<h4>' . Language::$dialog . '</h4>';
                    echo '<p><i>' . $model->content . '</i></p>';
                    echo '</div>';
                }
                ?>
            </div>
        ...
        <section class="col-lg-12 connectedSortable ui-sortable">
            <div class="box box-success">
                ...
                <div class="box-body">
                  <?php
                    if ($model->time_est){
                        echo '<p>' . sprintf(Language::$dialogTimeMessage, Functions::getTime($model->time_est * 60)) . '</p>';
                    }
                    if (count($timesheets) > 0){
                        echo '<p>' . sprintf(Language::$dialogTimeCurrentMessage, Functions::getTime($model->time)) . '</p>';
                        //print part times
