...
<section class="content-header">
  <h1 class="hidden-xs"><?php echo Language::$development; ?> <small><?php echo Language::$music; ?></small></h1>
        ...
        <div class="box-body">
    		...
    		<?php
    			if($model->file != null){
      				...
      				$file = Yii::app()->request->baseUrl . '/files/' . Yii::app()->user->company . '/' . $project->id . '/music/' . $model->id . '.' . end($ext);
      				if (file_exists($_SERVER['DOCUMENT_ROOT'] . $file)){
    				    echo '<div class="box-footer text-center">';
    				    echo '<h4>' . Language::$design . '</h4>';
    ...
    <section class="col-lg-12 connectedSortable ui-sortable">
        <div class="box box-success">
            ...
            <div class="box-body">
              <?php
                if ($model->time_est){
                    echo '<p>' . sprintf(Language::$musicTimeMessage, Functions::getTime($model->time_est * 60)) . '</p>';
                }
                if (count($timesheets) > 0){
                    echo '<p>' . sprintf(Language::$musicTimeCurrentMessage, Functions::getTime($model->time)) . '</p>';
                    //print part times
