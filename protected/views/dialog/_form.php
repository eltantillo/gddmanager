...
<div class="box-body">
	...
	<div class="form-group">
		<label><?php echo Language::$context; ?></label>
		<?php echo $form->textArea($model,'context', array('class'=>'form-control textarea', 'placeholder'=>Language::$contextDesc)); ?>
		<?php echo $form->error($model,'context'); ?>
	</div>

	<div class="form-group">
		<label><?php echo Language::$dialog; ?></label>
		<?php echo $form->textArea($model,'content', array('class'=>'form-control textarea', 'placeholder'=>Language::$dialogDesc)); ?>
